package frc.robot.utils.drive.generated;
...
/**
 * This file was generated by the Tuner X Swerve Project Generator:
 * <a href=
 * "https://v6.docs.ctr-electronics.com/en/stable/docs/tuner/tuner-swerve/index.html">Tuner
 * X Documentation</a>
 * 
 * <p>
 * <b>Note:</b>
 * </p>
 * <ul>
 * <li>Ensure inertias are set to the correct values:
 * <ul>
 * <li>Steer: 0.004</li>
 * <li>Drive: 0.025</li>
 * </ul>
 ...
 * </p>
 * <ul>
 * <li>Only use the values
 * from this file as a check. <b>This code is entirely unused in the
 * codebase</b></li>
 * <li>All other variables are private for a reason and must not be used under
 * any circumstance.</li>
 * </ul>
 * 
 */
public class TunerConstants {
    ...
    // This needs to be tuned to your individual robot
    private static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.55);
    ...
    private static final double kSteerInertia = 0.004; // FORCED VALUE
    private static final double kDriveInertia = 0.025; // FORCED VALUE
