...
public class DriveConstants {
	...
	public static final int kFrontLeftDrivePort = 2, // REV 16 CTRE 16
			kFrontLeftTurningPort = 12, // REV 16 CTRE 17
			kFrontLeftAbsEncoderPort = 22, // REV 2 CTRE 20
			kFrontRightDrivePort = 1, // REV 10 CTRE 10
			kFrontRightTurningPort = 11, // REV 11 CTRE 11
			kFrontRightAbsEncoderPort = 21, // REV 0 CTRE 21
			kBackLeftDrivePort = 3, // REV 14 CTRE 14
			kBackLeftTurningPort = 13, // REV 15 CTRE 15
			kBackLeftAbsEncoderPort = 23, // REV 3 CTRE 23
			kBackRightDrivePort = 4, // REV 12 CTRE 12
			kBackRightTurningPort = 14, // REV 13 CTRE 13
			kBackRightAbsEncoderPort = 24, // REV 1 CTRE 24
			kGyroPort = 31, // REV DOESN'T MATTER, USE kUSB1 CTRE 18
