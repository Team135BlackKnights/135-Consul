 ...
 */
public abstract class Goal implements Simulatable {
    ...
    public interface RotationChecker {
        boolean isValidRotation(GamePieceOnFieldDisplay gamePiece);
    }
    ...
    protected final CompetitionFieldSimulation arena;
    ...
    protected Predicate<GamePieceOnFieldDisplay> velocityValidator;
     ...
     */
    public Goal(
            CompetitionFieldSimulation arena,
            Distance xDimension,
            Distance yDimension,
            Distance height,
     ...
     * @return this Goal instance for method chaining
     */
    protected boolean checkValidity(GamePieceOnFieldDisplay gamePiece) {
     ...
     */
    protected boolean checkGrounded(GamePieceOnFieldDisplay gamePiece) {
        return allowGrounded || !gamePiece.isGrounded();
    }

    public Goal withCustomRotationValidator(Predicate<GamePieceOnFieldDisplay> validator) {
     ...
     * @return this Goal instance for method chaining
     */
    protected boolean checkCollision(GamePieceOnFieldDisplay gamePiece) {
        // Call our values just once.
     ...
     * @return this Goal instance for method chaining
     */
    public Goal withCustomVelocityValidator(Predicate<GamePieceOnFieldDisplay> validator) {
