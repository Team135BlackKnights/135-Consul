...
public final class Crescendo2024FieldObjects {
	...
	public static class NoteInFly extends GamePieceInSimulation {
		...
		public Pose3d getPose3d() {
			...
			double vNoughtZ = launchingSpeedMetersPerSec*Math.sin(startingPose.getRotation().getY()-Units.degreesToRadians(46));
			double vNoughtX = -launchingSpeedMetersPerSec*Math.cos(startingPose.getRotation().getY()-Units.degreesToRadians(46));
