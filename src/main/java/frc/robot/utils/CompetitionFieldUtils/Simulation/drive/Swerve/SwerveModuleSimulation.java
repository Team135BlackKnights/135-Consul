...
public class SwerveModuleSimulation {
  ...
  public SwerveModuleSimulation(
    ...
    this.steerRelativeEncoderPositionRad =
        steerAbsoluteFacing.getRadians();
  }
  ...
  /**
	* <h2>Updates the brake mode of the Steer Motor</h2>
   */
  public void setSteerMotorBrakeMode(boolean brakeMode) {
	 steerMotorSim.setMotorBrakeEnabled(brakeMode);
  }
  ...
  private void updateDriveEncoders() {
    this.driveEncoderUnGearedPositionRad +=
        this.driveEncoderUnGearedSpeedRadPerSec * RobotPhysicsSimulationConfigs.SIMULATION_DT;
