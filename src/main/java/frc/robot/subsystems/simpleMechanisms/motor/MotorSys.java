...
public abstract class MotorSys<G extends MotorSys.PositionGoal> extends SubsystemChecker {
  public interface PositionGoal {
  ...
  private final MotorSysIO io;
  protected final MotorSysIOInputsAutoLogged inputs = new MotorSysIOInputsAutoLogged();
  protected final Timer stateTimer = new Timer();
  private G lastGoal;

  public MotorSys(String name, MotorSysIO io) {
    this.name = name;
    this.io = io;
  ...
  public void periodic() {
    ...
    io.setPosition(getGoal().getPositionSupplier().getAsDouble());
