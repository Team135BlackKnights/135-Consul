...
public class Intake extends GenericRollerSystem<Intake.Goal> {
    public enum Goal implements GenericRollerSystem.VoltageGoal {
        IDLING(() -> 0),
        AMP_SCORING(new LoggableTunedNumber("Intake/AmpScoringVoltage", 12.0)),
        TRAP_SCORING(new LoggableTunedNumber("Intake/TrapScoringVoltage", 8.0)),
        TRAP_JACKHAMMER_OUT(new LoggableTunedNumber("Intake/JackhammerOutVoltage", 8.0)),
        TRAP_JACKHAMMER_IN(new LoggableTunedNumber("Intake/JackhammerInVoltage", -2.0)),
        EJECTING(new LoggableTunedNumber("Intake/EjectingVoltage", -12.0));
